#' @title diary 2014-2015
#'
#' @description A diary dataset describes the history notes during the MONIPAM observation period from 2014 to 2015. Note that in the package we also have data from 2016 to 2017, but we do not have a diary file for that observing season.
#'
