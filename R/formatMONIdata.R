...
#'
#' @usage formatMONIdata(moni.data)
...
#'
#' @return [formatMONIdata] will generate a MONI-PAM data with all the variables in proper data format for later data filtering and processing
#'
#' @export
formatMONIdata<-function(moni.data
                          ){
