...
```{r}
diurn.para<-fread('get parameters/2014_2015_diurnal_parameters.csv')
list.files('get parameters')
```
...
```{r}
MONI2016.2017<-
  read.MONIPAM(source.path=system.file("extdata/2016-2017/",package = "processMONIPAM"),
               pam.pattern = '.PAM',
               save.path = getwd(),# it is better to modify this to your local path
               site.lat =61.84562, # hyytiala latitude
               site.lon = 24.29077, # hyytiala longitude
